...
export default function Home() {
  return (
    <div className="pt-28 md:pt-40 px-4 md:px-8 max-w-[1600px] mx-auto pb-20 md:pb-32">
      {/* Hero */}
      <section className="min-h-[60vh] md:min-h-[70vh] flex flex-col justify-center mb-16 md:mb-24 mt-8 md:max-lg:mt-[-62px] md:max-lg:pt-0 md:mt-0">
        <Reveal>
          <div className="flex flex-wrap items-center gap-2 md:gap-4 mb-8 md:mb-12">
            <span className="px-3 py-1 md:px-4 bg-[#FFFF00] text-black text-[10px] md:text-xs font-bold uppercase tracking-widest">Private Executive Pitch</span>
            <span className="px-3 py-1 md:px-4 bg-black/5 dark:bg-white/10 text-black/60 dark:text-white/60 text-[10px] md:text-xs font-bold uppercase tracking-widest">Executive Briefing for Chibesakunda & Co.</span>
          </div>
          
          <div className="mb-4">
            <span className="text-[18px] md:text-base font-bold uppercase tracking-[0.3em] text-black/50 dark:text-white/50">
              Mapping Dept
            </span>
          </div>
          <h1 className="text-sculptural text-[66px] md:text-[103px] leading-[0.85] uppercase tracking-tighter mb-8 md:mb-12 break-words">
            Build The<br/>Future.
          </h1>
          
          <p className="text-editorial text-black dark:text-[#FFFF00] text-[16px] md:max-lg:text-[19px] md:text-2xl max-w-4xl leading-relaxed font-bold">
      ...
      <section className="mb-20 md:mb-32">
        <Reveal>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-16">
            <div className="lg:col-span-5 md:max-lg:mt-[-52px]">
              <h2 className="text-2xl md:text-3xl font-bold uppercase tracking-tighter leading-tight mb-6 md:mb-8">The Paradigm Shift</h2>
              <div className="glass-panel p-6 md:p-8 border-l-4 border-[#FFFF00]">
            ...
            <div className="lg:col-span-7 space-y-6 text-base md:text-lg text-black/80 dark:text-white/80 leading-relaxed font-medium">
              <p>
      ...
      <section className="mb-20 md:mb-32">
        <Reveal>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold uppercase tracking-tighter leading-tight mb-6 md:mb-8 pb-2 md:pb-4">Chi Siamo: GGM Surveyors</h2>
              <p className="text-black/70 dark:text-white/70 text-base md:text-lg leading-relaxed mb-6">
              ...
              <p className="text-black/70 dark:text-white/70 text-base md:text-lg leading-relaxed">
            ...
            <div className="glass-panel p-6 sm:p-10 lg:p-12 relative overflow-hidden group/container">
              ...
              <div className="absolute top-0 right-0 w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-[#FFFF00]/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3 transition-transform duration-1000 group-hover/container:translate-x-1/4" />
              
              <h3 className="text-xl sm:text-3xl font-bold uppercase tracking-tight mb-8 md:mb-10 relative z-10">Il Valore Aggiunto<br/><span className="text-black/40 dark:text-white/40 text-lg sm:text-2xl">in Southern Africa</span></h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
          <Reveal delay={0.1} className="h-full">
            <div className="glass-panel p-8 md:p-12 h-full">
              <Landmark className="w-8 h-8 md:w-10 md:h-10 text-black/50 dark:text-white/50 mb-6 md:mb-8" />
              <h3 className="text-xl md:text-2xl font-bold uppercase tracking-tight mb-4 md:mb-6">CCO's Focus & Expertise</h3>
              <p className="text-black/70 dark:text-white/70 leading-relaxed text-base md:text-lg mb-4 md:mb-6">
              ...
              <p className="text-black/70 dark:text-white/70 leading-relaxed text-base md:text-lg">
          ...
          <Reveal delay={0.2} className="h-full">
            <div className="glass-panel p-8 md:p-12 h-full">
              <Target className="w-8 h-8 md:w-10 md:h-10 text-black dark:text-[#FFFF00] mb-6 md:mb-8" />
              <h3 className="text-xl md:text-2xl font-bold uppercase tracking-tight mb-4 md:mb-6">The GGM Advantage</h3>
              <p className="text-black/70 dark:text-white/70 leading-relaxed text-base md:text-lg mb-4 md:mb-6">
      ...
      <section className="mb-20 md:mb-32">
        <Reveal>
          <h2 className="text-2xl md:text-3xl font-bold uppercase tracking-tighter leading-tight mb-8 md:mb-12 pb-2 md:pb-4">Strategic Synergies for CCO</h2>
        </Reveal>
      ...
      {/* Conclusion */}
      <section className="glass-panel p-8 md:p-16 mb-20 md:mb-32">
        <Reveal>
          <h2 className="text-2xl md:text-3xl font-bold uppercase tracking-tighter leading-tight mb-6 md:mb-8">Technological Sovereignty & Shared Vision</h2>
          <p className="text-lg md:text-xl text-black/80 dark:text-white/80 leading-relaxed max-w-4xl italic">
      ...
      <section className="mb-20 md:mb-32">
        <Reveal>
          <div className="bg-black text-white dark:bg-white dark:text-black p-8 md:p-16 -mx-[20px] md:mx-0">
            <div className="max-w-4xl mx-auto text-center">
              <img src="https://images.squarespace-cdn.com/content/v1/62963b756bf2c45d308b1e5a/1c31e27b-89ff-4f72-8e29-351edc4f8b21/GGM.EARTH_LOGO_W.png?format=2500w" alt="GGM.EARTH" className="w-[66px] h-[66px] object-contain mx-auto mb-6 md:mb-8 dark:invert" />
              <h2 className="text-2xl md:text-3xl font-bold uppercase tracking-tighter leading-tight mb-6 md:mb-8">Global Corporate Profile: GGM.EARTH</h2>
              <p className="text-base md:text-xl leading-relaxed mb-6 md:mb-8 opacity-80">
              ...
              <p className="text-[14px] leading-[22px] md:text-lg md:leading-relaxed mb-6 md:mb-8 text-white dark:text-black font-bold italic">
      ...
      {/* Call to Action */}
      <section className="text-center pt-10 md:pt-20 pb-8">
        <Reveal>
          <h2 className="text-3xl md:text-4xl font-bold uppercase tracking-tighter leading-tight mb-6 md:mb-8">Let's Schedule Our Call</h2>
          <p className="text-lg md:text-xl text-black/60 dark:text-white/60 mb-8 md:mb-12 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6">
            <a href="mailto:zambia@ggm.earth" className="w-full sm:w-auto bg-[#FFFF00] text-black px-8 md:px-12 py-4 font-bold uppercase tracking-widest hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-colors text-base md:text-lg">
              Reply to Surveyors
            </a>
            <Link to="/pillars" className="w-full sm:w-auto px-8 md:px-12 py-4 font-bold uppercase tracking-widest bg-black/5 dark:bg-white/10 hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-colors text-base md:text-lg">
